...
public class ArticlesControllerTests extends ControllerTestCase {
        ...
        public void an_admin_user_can_post_a_new_article() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=title&url=url&explanation=explanation&email=email&dateAdded=2022-01-03T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_article() throws Exception {
                ...
                Articles article_og = Articles.builder()
                .title("title")
                .url("url")
                .explanation("explanation")
                .email("email")
                ...
                String requestBody = mapper.writeValueAsString(article_new_ldt);

                when(articlesRepository.findById(eq(67L))).thenReturn(Optional.of(article_og));
                ...
                verify(articlesRepository, times(1)).save(article_new_ldt); // should be saved with correct user
                String responseString = response.getResponse().getContentAsString();
